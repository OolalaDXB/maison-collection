...
BEGIN
  -- 1. Lock rows FOR UPDATE (no aggregate)
  PERFORM 1
  FROM availability
  ...
  -- 2. Now count blocked dates (separate query, rows already locked)
