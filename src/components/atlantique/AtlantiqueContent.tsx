...
import {
  Waves, Building2, Mountain, TreePine, Bath, Car, Wifi
} from "lucide-react";
...
const features = [
  ...
  { icon: TreePine, label: "Bocage countryside" },
      ...
      <FadeIn>
        ...
        <div className="mb-8">
          ...
          <p className="font-body font-light text-muted-foreground text-sm">
            6 guests · 2 bedrooms · 2 bathrooms · 160m²
          </p>
        </div>
        ...
        <div className="mb-4">
          <p className="font-body font-light text-[hsl(0,0%,27%)] text-[1.05rem] leading-[1.8]">
            ...
            extension in Douglas fir with black pigmented cladding, creating 160m² of refined
            living space.
          </p>
