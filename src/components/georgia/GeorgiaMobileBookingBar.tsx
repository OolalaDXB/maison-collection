...
import GeorgiaBookingSidebar from "./GeorgiaBookingSidebar";
...
const GeorgiaMobileBookingBar = (props: Props) => {
...
export default GeorgiaMobileBookingBar;
