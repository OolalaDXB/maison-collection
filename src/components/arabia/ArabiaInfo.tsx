    ...
    <div className="border-t border-border pt-10 mb-10">
      ...
      <div className="space-y-4">
        <div className="flex items-start gap-3">
          ...
          <span className="font-body font-light text-sm text-[hsl(0,0%,27%)]">Check-in: 15:00</span>
        </div>
        <div className="flex items-start gap-3">
          <Calendar size={18} className="text-[hsl(0,0%,27%)] shrink-0 mt-0.5" strokeWidth={1.5} />
          <span className="font-body font-light text-sm text-[hsl(0,0%,27%)]">Check-out: 11:00</span>
        </div>
        <div className="flex items-start gap-3">
          <Car size={18} className="text-[hsl(0,0%,27%)] shrink-0 mt-0.5" strokeWidth={1.5} />
          <span className="font-body font-light text-sm text-[hsl(0,0%,27%)]">Parking: Free, on premises (solar-shaded car park)</span>
        </div>
        <div className="flex items-start gap-3">
