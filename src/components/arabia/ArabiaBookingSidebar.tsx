...
const ArabiaBookingSidebar = ({
  ...
  const bookSubject = checkIn && checkOut
    ? `Booking Maison Arabia — ${format(checkIn, "dd/MM/yyyy")} to ${format(checkOut, "dd/MM/yyyy")} — ${guests} guest${guests > 1 ? "s" : ""}`
    : "Booking Maison Arabia";
    ...
    <div className="border border-[hsl(0,0%,88%)] p-6">
      ...
      <div className="flex items-center gap-1.5 mb-5">
        ...
        <span className="font-body font-light text-sm text-muted-foreground">
          5.0 · Superhost ·{" "}
          <a href="#reviews" className="underline underline-offset-2 hover:text-foreground transition-colors cursor-pointer">2 reviews</a>
        </span>
      </div>
...
export default ArabiaBookingSidebar;
