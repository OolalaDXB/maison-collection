      ...
      <div className="max-container">
        ...
        <div className="border-t border-[#eeeeee] mt-12 pt-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-1 text-xs">
            <a href="#" className="font-body font-light text-[#666666] hover:text-[#1a1a1a] transition-colors">{t("footer.privacy")}</a>
            <span className="text-[#666666]">·</span>
            <a href="#" className="font-body font-light text-[#666666] hover:text-[#1a1a1a] transition-colors">{t("footer.terms")}</a>
          </div>
          <div className="flex items-center gap-4">
            <a href="https://instagram.com/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-[#666666] hover:text-[#1a1a1a] transition-colors"><Instagram size={18} aria-hidden="true" /></a>
            <a href="#" aria-label="Facebook" className="text-[#666666] hover:text-[#1a1a1a] transition-colors"><Facebook size={18} aria-hidden="true" /></a>
            <a href="#" aria-label="LinkedIn" className="text-[#666666] hover:text-[#1a1a1a] transition-colors"><Linkedin size={18} aria-hidden="true" /></a>
          </div>
        </div>
      </div>
    </footer>
